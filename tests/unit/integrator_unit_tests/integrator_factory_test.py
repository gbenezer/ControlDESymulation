...
class TestNumpyBackendCreation:
    ...
    def test_scipy_methods(self, mock_system, method):
        ...
        integrator = IntegratorFactory.create(mock_system, backend="numpy", method=method)
...
class TestJuliaSupport:
    ...
    def test_create_julia_integrator(self, mock_system):
        ...
        integrator = IntegratorFactory.create(
            mock_system, backend="numpy", method="Tsit5"  # Capital = Julia
        )
    ...
    def test_julia_nonstiff_algorithms(self, mock_system, algorithm):
        ...
        integrator = IntegratorFactory.create(mock_system, backend="numpy", method=algorithm)
    ...
    def test_julia_auto_switching(self, mock_system):
        ...
        integrator = IntegratorFactory.create(
            mock_system, backend="numpy", method="AutoTsit5(Rosenbrock23())"
        )
    ...
    def test_for_julia_factory_method(self, mock_system):
        ...
        integrator = IntegratorFactory.for_julia(mock_system, algorithm="Vern9", rtol=1e-12)
...
@pytest.mark.skipif(
    not __import__("importlib").util.find_spec("torch"), reason="PyTorch not installed"
)
class TestTorchBackendCreation:
    ...
    def test_fixed_step_methods_torch(self, mock_system, method):
        ...
        integrator = IntegratorFactory.create(
            mock_system, backend="torch", method=method, dt=0.01, step_mode=StepMode.FIXED
        )
    ...
    def test_torchdiffeq_method_available(self, mock_system):
        ...
        integrator = IntegratorFactory.create(
            mock_system, backend="torch", method="adaptive_heun"  # TorchDiffEq-specific
        )
...
@pytest.mark.skipif(not __import__("importlib").util.find_spec("jax"), reason="JAX not installed")
class TestJaxBackendCreation:
    ...
    def test_diffrax_explicit_methods(self, mock_system, method):
        ...
        integrator = IntegratorFactory.create(mock_system, backend="jax", method=method)
    ...
    def test_diffrax_reversible_methods(self, mock_system):
        ...
        integrator = IntegratorFactory.create(mock_system, backend="jax", method="reversible_heun")
...
class TestAutoSelection:
    ...
    @pytest.mark.skipif(
        not __import__("importlib").util.find_spec("jax"), reason="JAX not installed"
    )
...
class TestUseCaseFactories:
    ...
    def test_for_production_custom_tolerances(self, mock_system):
        ...
        integrator = IntegratorFactory.for_production(mock_system, rtol=1e-12, atol=1e-14)
    ...
    def test_for_julia_custom_algorithm(self, mock_system):
        ...
        integrator = IntegratorFactory.for_julia(
            mock_system, algorithm="Vern9", rtol=1e-12, atol=1e-14
        )
    ...
    def test_for_simple_simulation(self, mock_system):
        ...
        integrator = IntegratorFactory.for_simple_simulation(mock_system, dt=0.01)
    ...
    def test_for_real_time(self, mock_system):
        ...
        integrator = IntegratorFactory.for_real_time(mock_system, dt=0.01)
...
class TestRecommendationSystem:
    ...
    def test_recommend_with_gpu(self):
        ...
        rec = IntegratorFactory.recommend(
            "optimization", has_jax=True, has_torch=True, has_gpu=True
        )
...
class TestNamingConvention:
    ...
    def test_auto_switching_contains_parentheses(self):
        ...
        auto_methods = ["AutoTsit5(Rosenbrock23())", "AutoVern7(Rodas5())"]
...
class TestJuliaEdgeCases:
    ...
    def test_julia_with_custom_tolerances(self, mock_system):
        ...
        integrator = IntegratorFactory.create(
            mock_system, backend="numpy", method="Tsit5", rtol=1e-10, atol=1e-12
        )
    ...
    def test_julia_fixed_step_mode(self, mock_system):
        ...
        integrator = IntegratorFactory.create(
            mock_system, backend="numpy", method="Tsit5", dt=0.01, step_mode=StepMode.FIXED
        )
