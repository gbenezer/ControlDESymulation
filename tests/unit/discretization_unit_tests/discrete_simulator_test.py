...
class TestControllerTypes:
    ...
    def test_neural_network_controller(self):
        ...
        policy = nn.Sequential(nn.Linear(2, 1, bias=False))
...
class TestSimulationOptions:
    ...
    def test_return_controls(self):
        ...
        states, controls = sim.simulate(x0, steps=10, controller=u_seq, return_controls=True)
    ...
    def test_return_final_and_controls(self):
        ...
        x_final, controls = sim.simulate(
            x0, steps=10, controller=u_seq, return_final_only=True, return_controls=True
        )
...
class TestBatchedSimulation:
    ...
    def test_batched_with_sequence_controller_single(self):
        ...
        for i in range(batch_size):
            np.testing.assert_allclose(states[i, -1], np.array([1.0]), rtol=1e-10)
...
class TestDisturbances:
    ...
    def test_constant_disturbance(self):
        ...
        x0 = np.array([0.0])
        states = sim.simulate_with_disturbances(x0, steps=10, disturbance_func=disturbance)
...
class TestDiscreteVsDiscretized:
    ...
    def test_euler_discretized_matches_discrete(self):
        ...
        states_continuous = sim_continuous.simulate(x0, steps=10, controller=u_seq, dt=0.1)
...
class TestIntegration:
    ...
    def test_full_workflow_discrete(self):
        ...
        # Simulate
        x0 = np.array([1.0, 0.5])
        states, controls = sim.simulate(x0, steps=50, controller=controller, return_controls=True)
