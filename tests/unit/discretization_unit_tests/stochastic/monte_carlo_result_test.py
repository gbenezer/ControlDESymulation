...
def torch_mc_result():
    ...
    return MonteCarloResult(states=states, n_paths=n_paths, steps=steps)
...
class TestInitialization:
    ...
    def test_metadata_storage(self):
        ...
        result = MonteCarloResult(
            states=states, n_paths=5, steps=10, custom_field="test_value", another_field=42
        )
...
class TestStatistics:
    ...
    def test_get_statistics_numpy(self, numpy_mc_result):
        ...
        required_keys = ["mean", "std", "var", "min", "max", "median", "q05", "q25", "q75", "q95"]
...
class TestProbabilityExpectation:
    ...
    def test_compute_expectation_quadratic(self):
        ...
        expected_norm_sq = result.compute_expectation(lambda x: np.sum(x**2))
...
class TestCombination:
    ...
    def test_combine_with_controls_and_noise(self):
        ...
        for i in range(3):
            ...
            results.append(
                MonteCarloResult(states, controls=controls, noise=noise, n_paths=10, steps=5)
            )
    ...
    def test_combine_incompatible_steps_fails(self):
        ...
        result1 = MonteCarloResult(np.random.randn(10, 11, 2), n_paths=10, steps=10)
        result2 = MonteCarloResult(np.random.randn(10, 21, 2), n_paths=10, steps=20)
    ...
    def test_combine_incompatible_shapes_fails(self):
        ...
        result1 = MonteCarloResult(np.random.randn(10, 11, 2), n_paths=10, steps=10)
        result2 = MonteCarloResult(np.random.randn(10, 11, 3), n_paths=10, steps=10)
...
class TestErrorHandling:
    ...
    def test_unsupported_array_type_statistics(self):
        ...
        result = MonteCarloResult(states=[[1, 2], [3, 4]], n_paths=2, steps=1)  # Plain list
...
class TestIntegration:
    ...
    def test_full_workflow_numpy(self):
        ...
        # Create result
        result = MonteCarloResult(
            states=states, controls=controls, n_paths=n_paths, steps=steps, system_name="TestSystem"
        )
...
class TestAdvancedFeatures:
    ...
    def test_conditional_expectation(self):
        ...
        expectation = result.compute_expectation(lambda x: x[0] ** 2 + x[1] ** 2)
