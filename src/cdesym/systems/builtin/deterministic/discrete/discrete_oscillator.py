    ...
    def define_system(
        ...
        if method == "zoh":
            ...
            if zeta < 1:
                ...
                x_next = exp_decay * (x * sp.cos(omega_d * dt) + v * sp.sin(omega_d * dt) / omega_d)
                v_next = (
                    exp_decay * (-x * omega_d * sp.sin(omega_d * dt) + v * sp.cos(omega_d * dt))
                    + dt * u
                )
            ...
            x_next = x + 0.5 * dt * (
                v + (v - 2 * zeta_sym * omega_n_sym * v - omega_n_sym**2 * x + u)
            )
            v_next = v + 0.5 * dt * (
                ...
                + (
                    ...
                    * zeta_sym
                    * omega_n_sym
                    * (v + dt * (-2 * zeta_sym * omega_n_sym * v - omega_n_sym**2 * x + u))
                    - omega_n_sym**2 * (x + dt * v)
                    + u
                )
            )
