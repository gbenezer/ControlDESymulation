...
Design Note
-----------
This module now uses TypedDict-based result types from controldesymulation.types.trajectories,
...
from cdesym.types.trajectories import IntegrationResult, TimePoints, TimeSpan
