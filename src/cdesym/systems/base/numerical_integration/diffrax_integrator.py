...
Design Note
-----------
This module uses TypedDict-based result types from controldesymulation.types.trajectories
and semantic types from controldesymulation.types.core, following the project design principles:
