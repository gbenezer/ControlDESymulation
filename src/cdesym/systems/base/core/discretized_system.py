...
class DiscretizedSystem(DiscreteSystemBase):
    ...
    @staticmethod
    def get_available_methods(backend: Backend = "numpy", method_type: Literal["all", "deterministic", "stochastic", "fixed_step", "adaptive"] = "all") -> dict:
        """
        ...
        """
        from cdesym.systems.base.numerical_integration.method_registry import get_available_methods
    ...
    def __init__(
        ...
        **Symbolic Systems:**
        ...
        >>> from controldesymulation.systems.examples import SymbolicCartPole
        ...
        **Backend Detection:**
        ...
        # ========================================================================
        # Determine if method is fixed-step (using method_registry method)
        # ========================================================================
...
def discretize_batch(continuous_system, dt, method="LSODA", **kwargs):
    ...
    **Stiff system:**
    ...
    >>> from controldesymulation.systems.examples import VanDerPol
