...
class Discretizer:
    ...
    def linearize(
        self, x_eq: ArrayLike, u_eq: Optional[ArrayLike] = None, method: str = "euler"
    ...
    def _linearize_euler(self, Ac: ArrayLike, Bc: ArrayLike) -> Tuple[ArrayLike, ArrayLike]:
        """
    ...
    def _linearize_exact(self, Ac: ArrayLike, Bc: ArrayLike) -> Tuple[ArrayLike, ArrayLike]:
        """
    ...
    def _linearize_tustin(self, Ac: ArrayLike, Bc: ArrayLike) -> Tuple[ArrayLike, ArrayLike]:
        """
    ...
    def _linearize_matched(self, Ac: ArrayLike, Bc: ArrayLike) -> Tuple[ArrayLike, ArrayLike]:
        """
