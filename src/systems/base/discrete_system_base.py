...
class DiscreteSystemBase(ABC):
    ...
    @abstractmethod
    def step(self, x: ArrayLike, u: Optional[ArrayLike] = None, **kwargs) -> ArrayLike:
        """
    ...
    @abstractmethod
    def linearize(
        self, x_eq: ArrayLike, u_eq: Optional[ArrayLike] = None, **kwargs
    ) -> LinearizationResult:
        """
    ...
    def batch_step(
        self, x_batch: ArrayLike, u_batch: Optional[ArrayLike] = None, **kwargs
    ) -> ArrayLike:
        """
    ...
    def __call__(self, x: ArrayLike, u: Optional[ArrayLike] = None) -> ArrayLike:
        """
    ...
    def is_controllable(
        self, x_eq: ArrayLike, u_eq: Optional[ArrayLike] = None, **linearize_kwargs
    ) -> bool:
        """
    ...
    def __repr__(self) -> str:
        ...
        return f"{self.__class__.__name__}(" f"nx={self.nx}, nu={self.nu}, {stochastic_str})"
...
def simulate_discrete(
    system: DiscreteSystemBase, x0: ArrayLike, u_seq: Optional[ArrayLike] = None, steps: int = 100
) -> ArrayLike:
    """
...
def check_discrete_stability(
    system: DiscreteSystemBase, x_eq: ArrayLike, u_eq: Optional[ArrayLike] = None
) -> bool:
    """
