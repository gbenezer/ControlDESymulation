        ...
        sde_info = {
            **base_info,
            ...
            "noise": {
                ...
                "state_dependencies": [
                    str(s) for s in self.noise_characteristics.state_dependencies
                ],
                "control_dependencies": [
                    str(s) for s in self.noise_characteristics.control_dependencies
                ],
            },
            "recommended_solvers": {
    ...
    def to_deterministic(self):
        ...
        class DeterministicWrapper(SymbolicDynamicalSystem):
            ...
            def define_system(self):
                ...
                self._h_sym = (
                    self._source_sde._h_sym if hasattr(self._source_sde, "_h_sym") else None
                )
