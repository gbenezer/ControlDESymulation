...
```bash
# CUDA 12
pip install cdesym "jax[cuda12]"

# CUDA 11
pip install cdesym "jax[cuda11]"
```
...
For full functionality with all backends:

```bash
pip install cdesym torch jax jaxlib
```
