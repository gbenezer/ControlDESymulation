...
The framework consists of **4 architectural layers**, each documented separately:
...
### 2. [Delegation Layer](Delegation_Layer_Architecture.qmd)
...
### 3. [Integration Framework](Integration_Framework_Architecture.qmd)
...
### 4. [Visualization Framework](Visualization_Framework_Architecture.qmd)
...
- **39 core files** organized into 4 architectural layers
...
**Long answer:** See [Design Philosophy](cdesym_Design_Philosophy.qmd#sec-zero-code-duplication)
...
2. **Study the relevant layer docs** for your contribution area
3. **Follow the established patterns** (composition, type-driven design, etc.)
4. **Write comprehensive tests** for each component in isolation
5. **Document your additions** with clear examples and type annotations
